---
title: Fiber optics sensing sheds new light on physical ocean processes 
summary: Using Distributed Acoustic Sensing (DAS) on existing seafloor fiber optic cables to monitor ocean processes such as temperature, wave heights or seafloor currents.
...
image:
  # To use an image, place it in this project's folder and name it `featured.jpg` or `featured.png`.
  caption: 'Temperature variations along the continental shelf, offshore Toulon, South of France. Image credit: [**Pelaez et al., 2023, Scientific Reports**]'
  focal_point: Smart
...
![Wave height reconstruction from DAS data (black) compared with reference seafloor pressure sensor (red).](wave-height.jpg "Wave height reconstruction from DAS data. Credit: Meulé et al., 2024")
...
![Comparison of current speed derived from DAS data (dark blue) and a nearby reference current meter (black) on the deep seafloor of the Mediterranean ocean.](currentmeter.jpg "Turning seafloor cables into current meters. Credit: Mata et al., 2023")
